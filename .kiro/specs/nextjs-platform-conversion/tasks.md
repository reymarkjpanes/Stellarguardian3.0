...
- [x] 1. Project foundation and tooling
  - [x] 1.1 Scaffold Next.js App Router project and directory structure
  ...
  - [x] 1.2 Configure TypeScript strict mode, linting, and the test toolchain
  ...
  - [x] 1.3 Remove dead integrations and duplicate dependencies
...
- [x] 2. Shared Zod type system
  - [x] 2.1 Define Zod schemas as the single source of truth in `/types`
...
- [x] 3. Supabase clients, migrations, and RLS
  ...
  - [x] 3.2 Author initial database migrations for all core tables
  ...
  - [x] 3.3 Implement RLS policies and append-only audit enforcement
  ...
  - [x] 3.5 Implement authentication pages and session flow
...
- [x] 4. Shared state machine module
  - [x] 4.1 Implement the event lifecycle state machine
  ...
  - [x]* 4.5 Write property test for cumulative-funding escrow state
    - **Property 12: Cumulative funding drives escrow state**
    - **Validates: Requirements 26.1, 26.2, 26.4**

  - [x] 4.6 Implement the dispute lifecycle state machine
    - Implement `canDisputeTransition` with role- and filer-gated transitions and terminal state set
    - _Requirements: 39.1, 39.3, 39.4_

- [x] 5. Error model, response envelope, and permission matrix
  - [x] 5.1 Implement the typed error hierarchy and global error handler
  ...
  - [x]* 5.2 Write property test for the canonical envelope and status mapping
    - **Property 27: Responses use the canonical envelope and status mapping**
    - **Validates: Requirements 12.2, 18.1, 18.2, 18.3**

  - [x]* 5.3 Write property test for leak-free 500 on unhandled exceptions
    - **Property 30: Unhandled exceptions yield a leak-free 500**
    - **Validates: Requirements 18.4, 20.5**

  - [x] 5.4 Implement the permission matrix and authorize helper
  ...
  - [x]* 5.5 Write property test for permission-matrix scope enforcement
...
- [x] 6. Request pipeline middleware
  - [x] 6.1 Implement authentication, validation composition, and request tracing
  ...
  - [x] 6.4 Implement rate limiting and security headers
...
- [x] 7. Wallet adapter and verifier
  - [x] 7.1 Implement the wallet adapter interface and Freighter adapter
  ...
  - [x] 7.2 Implement the server-side challenge-response wallet verifier
...
- [x] 8. Chain adapter and Stellar client
  - [x] 8.1 Implement the chain adapter and Stellar client
...
- [x] 9. Idempotency and optimistic concurrency
  - [x] 9.1 Implement the idempotency service
  ...
  - [x] 9.4 Implement optimistic concurrency control
...
- [x] 11. Notification, audit, and activity services
  - [x] 11.1 Implement the append-only audit service
  ...
  - [x] 11.4 Implement the notification and activity-timeline service
...
- [x] 12. Escrow service
  - [x] 12.1 Implement escrow keypair generation and funding verification
  ...
  - [x] 12.5 Implement escrow reconciliation and public verification endpoint
  ...
  - [x]* 12.6 Write property test for reconciliation mismatch flagging
    - **Property 13: Reconciliation mismatch flags and blocks**
    - **Validates: Requirements 26.5, 26.7**

  - [x] 12.7 Implement prize allocation validation
  ...
  - [x] 12.9 Implement batched disbursement
  ...
  - [x] 12.12 Implement the refund path and deletion guard
...
- [x] 14. Dispute service and objection window
  - [x] 14.1 Implement the dispute service and objection window
  ...
  - [x]* 14.2 Write property test for open-by-accepted-participant-in-window
  ...
  - [x]* 14.3 Write property test for role-gated dispute transitions
  ...
  - [x] 14.5 Implement disbursement-blocking and window-elapse resolution
...
- [x] 15. Teams, judging, and submissions services
  - [x] 15.1 Implement the team formation and management service
  ...
  - [x] 15.4 Implement the judging and conflict-of-interest service
  ...
  - [x] 15.7 Implement the submission draft and versioning service
  ...
  - [x] 15.11 Implement file validation, malware scanning, and upload pipeline
  ...
  - [x]* 15.12 Write property test for file validation
    - **Property 43: File validation accepts only conforming uploads**
    - **Validates: Requirements 30.4, 30.5, 30.6, 36.4**

- [x] 16. Workspaces, discovery, and compliance services
  - [x] 16.1 Implement the workspace management service
  ...
  - [x] 16.4 Implement event discovery and search
  ...
  - [x] 16.6 Implement legal acceptance, disclaimers, and mainnet/KYC gating
  ...
  - [x] 16.9 Implement account deactivation, deletion, and data export
  ...
  - [x] 16.11 Implement public content reporting and moderation review
...
- [x] 17. Extensibility: public API, webhooks, plugins, feature flags
  - [x] 17.1 Implement the versioned public API, webhooks, plugins, and feature flags
...
- [x] 18. Split paginated API endpoints
  - [x] 18.1 Implement cursor-based pagination and split event sub-resources
  ...
  - [x] 18.3 Wire financial and state-transition route handlers
  ...
  - [x] 18.6 Implement health and readiness endpoints
...
- [x] 20. Frontend: dashboards, wallet UI, and shared UI states
  - [x] 20.1 Implement shared UI: data tables, loading/empty/error states, and accessibility
  ...
  - [x] 20.2 Implement the wallet UI, onboarding, and connection-state flow
  ...
  - [x] 20.3 Implement role-specific dashboards
  ...
  - [x] 20.4 Implement sponsor and milestone management UI and public event page
