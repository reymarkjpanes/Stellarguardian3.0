...
// setupJudgingFixture, judgeAuth, workspaceData reserved for full implementation
...
test.describe("Judging Workspace - Split Screen", () => {
  ...
  test("should render split screen layout with submission and scoring panels", async () => {
  ...
  test("should autosave draft after score changes", async () => {
  ...
  test("should enforce validation rules and prevent invalid submission", async () => {
