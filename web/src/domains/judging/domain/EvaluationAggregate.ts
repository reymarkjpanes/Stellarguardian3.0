import { EvaluationLifecycleState, EvaluationEvent, EvaluationStateMachine } from './EvaluationStateMachine';
...
export class EvaluationAggregate {
  ...
  get status() { return this.stateMachine.currentState; }
  get scores() { return this.props.scores; }
  ...
  public submit(scores: EvaluationScores, participantFeedback?: string, organizerNotes?: string, calculatedTotalScore: number = 0) {
