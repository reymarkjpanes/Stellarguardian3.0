import { EscrowProvider, EscrowFundingVerification, PayoutInstruction, ProviderIdentity } from '../domain/EscrowProvider';
...
export class MockStellarAdapter implements EscrowProvider {
  ...
  async simulatePayoutBatch(address: string, instructions: PayoutInstruction[]): Promise<{ isValid: boolean; estimatedFee: number; errors?: any }> {
    ...
    // Simulate invalid simulation if any instruction amount is negative
