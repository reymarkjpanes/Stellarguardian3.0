-- Migration: fix_create_event_rpc_availability
--
-- Fixes the 42703 error by using 'availability' instead of 'status' for event_members, 
-- which was renamed in 20250101000023_module2_memberships.sql.
-- Also fixes the 23514 error by using a valid availability enum value ('Available') instead of 'accepted'.
